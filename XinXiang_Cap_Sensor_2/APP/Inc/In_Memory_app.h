...
#define SYSPARAM_FLAG_BAK1_PROGRAMED        ((uint32_t)(SYSPARAM_FLAG_BASE_ADDRESS + 0x800))
...
#define SYSPARAM_FLAG_BAK2_PROGRAMED        ((uint32_t)(SYSPARAM_FLAG_BAK1_PROGRAMED + 0x800))
