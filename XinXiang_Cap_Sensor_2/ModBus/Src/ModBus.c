...
/* 使用soway上位机升级程序(Boot程序), BOOT_PROGRAM在main.h中定义 */
    ...
    ModBusBaseParam->ModBus_CallBack = NULL;                                //ModBus回调函数设为NULL
    ...
    ModBusBaseParam->ModBus_TX_RX.Send_Len = 0;                             //ModBus发送数据的长度
    
    Sensor_USART_Init(ModBusBaseParam->BaudRate, ModBusBaseParam->Parity);  //初始化串口
}
...
/******************************************** 查找DAC设备 **********************************************/
    ...
    {
        ModBus_Device.dac_device = dac_device;
    }  
/*******************************************************************************************************/
...
/******************************************** 查找PWM设备 **********************************************/
    // 查找PWM设备
    pwm_device = rt_device_find("pwm3");         
    if(pwm_device != RT_NULL)
    {
        ModBus_Device.pwm_device = pwm_device;
    }  
/*******************************************************************************************************/
