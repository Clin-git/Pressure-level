        ...
        {        
            case 0x0080:                                                        //电容量程
                fBuf = (float)Device_Param->PCap_DataConvert->CapMax        
                        - (float)Device_Param->PCap_DataConvert->CapMin;        //电容零点
...
#ifdef USING_PWM
            case 0x00A0:     
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM0;          //PWM 0点
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00A2:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM1;          //PWM 1点
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00A4:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM2;          //PWM 2点
                DataBuf = *(uint32_t *)&fBuf;
            break;  
              
            case 0x00A6:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM3;          //PWM 3点
                DataBuf = *(uint32_t *)&fBuf;
            break; 
            
            case 0x00A8:     
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM4;          //PWM 4点
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00AA:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM5;          //PWM 5点
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00AC:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High0;     //PWM 0点高度
                DataBuf = *(uint32_t *)&fBuf;
            break;  
              
            case 0x00AE:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High1;     //PWM 1点高度
                DataBuf = *(uint32_t *)&fBuf;
            break; 
            
            case 0x00B0:     
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High2;     //PWM 2点高度
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00B2:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High3;     //PWM 3点高度
                DataBuf = *(uint32_t *)&fBuf;
            break;
              
            case 0x00B4:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High4;     //PWM 4点高度
                DataBuf = *(uint32_t *)&fBuf;
            break;  
              
            case 0x00B6:
                fBuf = (float)Device_Param->PCap_DataConvert->CapPWM_High5;     //PWM 5点高度
                DataBuf = *(uint32_t *)&fBuf;
            break; 
#endif // USING_PWM
            default:
...
//            break;
            ...
            case 0x0082:            
                ...
                InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapMin),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapMin, 
                                            sizeof(Device_Param->PCap_DataConvert->CapMin));
            break;
              
            case 0x0084:
                Device_Param->PCap_DataConvert->CapMax = (uint32_t)fbuf;
                Device_Param->DataFilter->InputRangeMax = (uint32_t)fbuf;
                InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapMax),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapMax, 
                                            sizeof(Device_Param->PCap_DataConvert->CapMax));
            break;
#ifdef USING_DAC
            case 0x0088:
                ...
                else if(fbuf <= PCAP_DAC_MAX_VALUE && fbuf >= PCAP_DAC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDAMin),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapDAMin, 
                                            sizeof(Device_Param->PCap_DataConvert->CapDAMin));
                }
                else
                {
                    goto __error;
            ...
            case 0x008A:
                ...
                else if(fbuf <= PCAP_DAC_MAX_VALUE && fbuf >= PCAP_DAC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDALow),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapDALow, 
                                            sizeof(Device_Param->PCap_DataConvert->CapDALow));
                }                
                else
                {
                    goto __error;
            ...
            case 0x008C:
                ...
                else if(fbuf <= PCAP_DAC_MAX_VALUE && fbuf >= PCAP_DAC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDAHigh),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapDAHigh, 
                                            sizeof(Device_Param->PCap_DataConvert->CapDAHigh));
                }
                else
                {
                    goto __error;
            ...
            case 0x008E:                
                ...
                else if(fbuf <= PCAP_DAC_MAX_VALUE && fbuf >= PCAP_DAC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDAMax),
                                            (uint8_t *)&Device_Param->PCap_DataConvert->CapDAMax, 
                                            sizeof(Device_Param->PCap_DataConvert->CapDAMax));
                }
                else
                {
                    goto __error;
            ...
            case 0x0098:       
                if(fbuf <= PCAP_ADC_MAX_VALUE && fbuf >= PCAP_ADC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapADMin),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapADMin, 
                                                sizeof(Device_Param->PCap_DataConvert->CapADMin));
                }   
                else
                {
                    goto __error;
            ...
            case 0x009A:
                if(fbuf <= PCAP_ADC_MAX_VALUE && fbuf >= PCAP_ADC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapADLow),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapADLow, 
                                                sizeof(Device_Param->PCap_DataConvert->CapADLow));
                }
                else
                {
                    goto __error;
            ...
            case 0x009C:
                if(fbuf <= PCAP_ADC_MAX_VALUE && fbuf >= PCAP_ADC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapADHigh),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapADHigh, 
                                                sizeof(Device_Param->PCap_DataConvert->CapADHigh));
                }      
                else
                {
                    goto __error;
            ...
            case 0x009E:
                if(fbuf <= PCAP_ADC_MAX_VALUE && fbuf >= PCAP_ADC_MIN_VALUE)
                {
                    ...
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapADMax),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapADMax, 
                                                sizeof(Device_Param->PCap_DataConvert->CapADMax));
                }         
                else
                {
                    goto __error;
            ...
            case 0x00A0:                                                            //PWM 0点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM0 = (uint16_t)fbuf;        
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM0),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM0, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM0));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00A2:                                                            //PWM 1点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM1 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM1),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM1, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM1));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00A4:                                                            //PWM 2点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM2 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM2),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM2, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM2));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00A6:                                                            //PWM 3点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM3 = (uint16_t)fbuf;        
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM3),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM3, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM3));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00A8:                                                            //PWM 4点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM4 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM4),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM4, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM4));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00AA:                                                            //PWM 5点
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM5 = (uint16_t)fbuf;        
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM5),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM5, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM5));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00AC:                                                            //PWM 0点高度
                ...
                {
                    Device_Param->PCap_DataConvert->CapPWM_High0 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High0),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High0, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High0));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00AE:                                                            //PWM 1点高度
                if(fbuf <= PCAP_PWM_HIGH_MAX_VALUE && fbuf >= PCAP_PWM_HIGH_MIN_VALUE)
                {
                    Device_Param->PCap_DataConvert->CapPWM_High1 = (uint16_t)fbuf;        
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High1),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High1, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High1));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00B0:                                                            //PWM 2点高度
                if(fbuf <= PCAP_PWM_HIGH_MAX_VALUE && fbuf >= PCAP_PWM_HIGH_MIN_VALUE)
                {
                    Device_Param->PCap_DataConvert->CapPWM_High2 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High2),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High2, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High2));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00B2:                                                            //PWM 3点高度
                if(fbuf <= PCAP_PWM_HIGH_MAX_VALUE && fbuf >= PCAP_PWM_HIGH_MIN_VALUE)
                {
                    Device_Param->PCap_DataConvert->CapPWM_High3 = (uint16_t)fbuf;          
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High3),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High3, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High3));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00B4:                                                            //PWM 4点高度
                if(fbuf <= PCAP_PWM_HIGH_MAX_VALUE && fbuf >= PCAP_PWM_HIGH_MIN_VALUE)
                {
                    Device_Param->PCap_DataConvert->CapPWM_High4 = (uint16_t)fbuf;         
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High4),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High4, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High4));
                }   
                else
                {
                    goto __error;
            ...
            case 0x00B6:                                                            //PWM 5点高度
                if(fbuf <= PCAP_PWM_HIGH_MAX_VALUE && fbuf >= PCAP_PWM_HIGH_MIN_VALUE)
                {
                    Device_Param->PCap_DataConvert->CapPWM_High5 = (uint16_t)fbuf;        
                    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM_High5),
                                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM_High5, 
                                                sizeof(Device_Param->PCap_DataConvert->CapPWM_High5));
                }   
                else
                {
                    goto __error;
...
void MB_CapDAOut_Calibration(void *arg)
{
    ...
    Device_Param->PCap_DataConvert->CapDAMin = Calib_DAMin;
    Device_Param->PCap_DataConvert->CapDALow = Calib_DALow;
    Device_Param->PCap_DataConvert->CapDAHigh = Calib_DAHigh;
    Device_Param->PCap_DataConvert->CapDAMax = Calib_DAMax;                
    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDAMin),
                                (uint8_t *)&Device_Param->PCap_DataConvert->CapDAMin, 
                                sizeof(Device_Param->PCap_DataConvert->CapDAMin));
    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapDALow),
...
void MB_TempDAOut_Calibration(void *arg)
{
    ...
    if((Calib_TempDAMax > Calib_TempDAMin) && (Calib_TempDAMax <= DAC_VALUE_MAX))
    {
        ...
        InMemory_Write2T_MultiBytes((uint32_t)&(((ADC_TemperParam_TypeDef *)ADC_TEMPERPARAM_BASE_ADDRESS)->TempDAMin),
                                    (uint8_t *)&Device_Param->ADC_TemperParam->TempDAMin, 
                                    sizeof(Device_Param->ADC_TemperParam->TempDAMin));
        InMemory_Write2T_MultiBytes((uint32_t)&(((ADC_TemperParam_TypeDef *)ADC_TEMPERPARAM_BASE_ADDRESS)->TempDAMax),
                                    (uint8_t *)&Device_Param->ADC_TemperParam->TempDAMax, 
                                    sizeof(Device_Param->ADC_TemperParam->TempDAMax));                
    }
}
#endif // USING_ADC_TEMPER_SENSOR
...
void MB_CapPWMOut_Calibration(void *arg)
{
    ...
    Device_Param->PCap_DataConvert->CapPWM0 = Calib_PWM0;
    Device_Param->PCap_DataConvert->CapPWM1 = Calib_PWM1;
    Device_Param->PCap_DataConvert->CapPWM2 = Calib_PWM2;
    Device_Param->PCap_DataConvert->CapPWM3 = Calib_PWM3;
    Device_Param->PCap_DataConvert->CapPWM4 = Calib_PWM4;
    Device_Param->PCap_DataConvert->CapPWM5 = Calib_PWM5;
    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM0),
                                (uint8_t *)&Device_Param->PCap_DataConvert->CapPWM0, 
                                sizeof(Device_Param->PCap_DataConvert->CapPWM0));
    InMemory_Write2T_MultiBytes((uint32_t)&(((PCap_DataConvert_Param *)PCAP_PARAM_BASE_ADDRESS)->CapPWM1),
