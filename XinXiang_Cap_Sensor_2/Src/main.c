...
/******************************************* 初始化外设模块 ********************************************/
    ...
    DataConvert_Out.PCap_PWM_Value = 5910;
...
/*********************************************** PWM处理 ***********************************************/
                    ...
                    tim_dev[TIM3_INDEX].tim_get_pwm(TIM_CHANNEL_2,&PCap_PWM_Period_Old, NULL);
...
/*******************************************************************************************************/                    
            ...
            if(Sensor_PCap_GetResult(RESULT_REG10_ADDR, 
                                    ...
                                    1) == OP_SUCCESS)
            {            
                temp_res_value = PCap_GetTemp(temp_buf / 2097152.0);
                DataConvert_Out.PCap_Temper_Value = (temp_res_value + 273.1 + 0.5) * 10;
            }
            //记录当前时间为下一次采集电容值重新计时
